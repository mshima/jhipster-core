...
function createApplicationConfigurationFromObject(configurationObject = {}, options = {}) {
  const { exportGenericConfigs } = options;
...
function createJDLConfigurationOption(name, value) {
  ...
  try {
    ...
    return new GenericJDLApplicationConfigurationOption(name, value);
  }
  switch (type) {
