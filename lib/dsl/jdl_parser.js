...
module.exports = class JDLParser extends CstParser {
  ...
  parse() {
    ...
    this.applicationSubConfigWithAnnotations();
  ...
  applicationSubDeclaration() {
    this.RULE('applicationSubDeclaration', () => {
      this.MANY(() => {
        this.OR([
          { ALT: () => this.SUBRULE(this.applicationSubConfigWithAnnotations) },
  ...
  applicationSubConfigWithAnnotations() {
    this.RULE('applicationSubConfigWithAnnotations', () => {
      this.MANY(() => {
        this.SUBRULE(this.annotationDeclaration);
      });
      this.SUBRULE(this.applicationSubConfig);
    });
  }
