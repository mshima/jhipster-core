 ...
 */
function convertApplications(parsedApplications, configuration = {}, entityNames = [], options = {}) {
  ...
  return parsedApplications.map(parsedApplication => {
    ...
    const jdlApplication = createJDLApplication(applicationWithCustomValues.config, options);
