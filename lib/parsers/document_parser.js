 ...
 */
function parseFromConfigurationObject(configurationObject, options = {}) {
  ...
  init(configurationObject, options);
  fillApplications(options);
  fillDeployments();
  fillEnums();
...
function fillApplications(options) {
  const jdlApplications = convertApplications(parsedContent.applications, configuration, entityNames, options);
